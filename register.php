  ...
  <div class="container mt-5">
    ...
    <form class="mx-auto" style="max-width: 400px;" action="php_controllers/registerController.php" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nom" placeholder="Escriu el teu nom" required>
      </div>

      <!-- Camp Contrasenya -->
      <div class="mb-3">
        <label for="contrasenya" class="form-label">Contrasenya</label>
        <input type="password" class="form-control" id="contrasenya" placeholder="Escriu una contrasenya" required>
      </div>
